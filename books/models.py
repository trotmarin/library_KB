...
class BookRentHistory(models.Model):
    book = models.ForeignKey(
        Book, on_delete=models.CASCADE, editable=True)
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, editable=True, related_name='books')
    rent_date = models.DateField(auto_now_add=True, editable=True)
